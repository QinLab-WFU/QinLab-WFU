* Kun Cheng#, <strong><u>Qibing Qin</u></strong>*, Wenfeng Zhang, Lei Huang. Deep Discriminative Global Relevance Hashing for Cross-modal Retrieval. the 34th ACM International Conference on Multimedia, 2026. (CCF-A类会议, 多媒体领域顶级学术会议) [[Code]](https://github.com/QinLab-WFU/DDGRH)

* Kun Cheng#, <strong><u>Qibing Qin</u></strong>*, Lei Huang. Deep Discriminative Structure Proxy Hashing for Cross-modal Retrieval. Forty-Third International Conference on Machine Learning 2026. (CCF-A类会议, 人工智能领域顶级学术会议) [[Code]](https://github.com/QinLab-WFU/DDSPH)[[PDF]](https://openreview.net/pdf?id=bjxkOak8TD)

* Hao Sun#, <strong><u>Qibing Qin</u></strong>*, Lei Huang. Robust Self-reflective Hashing for Cross-modal Retrieval with Noisy Label. Forty-Third International Conference on Machine Learning 2026. (CCF-A类会议, 人工智能领域顶级学术会议) [[Code]](https://github.com/QinLab-WFU/RSH)[[PDF]](https://openreview.net/pdf?id=jyGcO0W5xd)
  
* Hao Sun#, Yadong Huo, <strong><u>Qibing Qin</u></strong>*, Wenfeng Zhang, Lei Huang. Intra-class Distribution-guided Generative Hashing with Neighbor Refinement for Cross-modal Retrieval. The IEEE/CVF Conference on Computer Vision and Pattern Recognition 2026. (CCF-A类会议, 人工智能和计算机视觉领域顶级学术会议，<strong>入选Highlight论文</strong>) [[Code]](https://github.com/QinLab-WFU/IDGH)[[PDF]](https://openaccess.thecvf.com/content/CVPR2026/html/Sun_Intra-class_Distribution-guided_Generative_Hashing_with_Neighbor_Refinement_for_Cross-modal_Retrieval_CVPR_2026_paper.html)
...
* Lei Wu#, <strong><u>Qibing Qin</u></strong>*, Yuxin Cao, Wenfeng Zhang, Lei Huang. Deep Augmented Inter-class Hashing for Cross-Modal Retrieval. Information Fusion, 2026: 104595. (CAAI-A类期刊，信息融合领域权威期刊，IF=17.4) [[Code]](https://github.com/QinLab-WFU/DAIH)[[PDF]](https://www.sciencedirect.com/science/article/abs/pii/S1566253526004732)
...
* Congcong Zhu, <strong><u>Qibing Qin</u></strong>*, Wenfeng Zhang, Lei Huang. Deep neighbor-coherence hashing with discriminative sample mining for supervised cross-modal retrieval. Expert Systems with Applications, 2025: 127365. [[Code]](https://github.com/QinLab-WFU/DNcH)[[PDF]](https://www.sciencedirect.com/science/article/pii/S095741742500987X)
